> **程序注入说明**：阶段 2 批次 2/3。占位符由 `PromptBuilder.build_skill_batch_prompt` 替换。

## 角色
你是跑团规则设计师，根据世界设定设计**社交与调查**类轻规则标签。
...
## 输出要求
1. 顶层**仅**包含 `skills` 数组。
2. 本批 **3–5** 个技能，侧重：说服、欺骗、洞察、追踪、审讯、情报等。
